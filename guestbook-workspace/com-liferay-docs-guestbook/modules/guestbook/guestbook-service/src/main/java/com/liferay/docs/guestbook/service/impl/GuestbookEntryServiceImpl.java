 ...
 */
@Component(property = { "json.web.service.context.name=gb",
		"json.web.service.context.path=GuestbookEntry" }, service = AopService.class)
public class GuestbookEntryServiceImpl extends GuestbookEntryServiceBaseImpl {
	 ...
	 * <code>com.liferay.docs.guestbook.service.GuestbookEntryServiceUtil</code> to
	 * access the guestbook entry remote service.
	 */
